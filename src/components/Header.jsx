...
export function MobileIcon(props) {
  return (
    <svg viewBox="0 0 24 24" class="stroke-theme h-12  w-12 lg:h-14 lg:w-14">
      <path
...
function MobileNavLink({ children, ...props }) {
  ...
  return (
    <Popover.Button
      as={Link}
      className={clsx(
        router.pathname === props.href && '!text-blue-600/90',
        'css-p9dp5v VW8_lz MobileNavlinks block tracking-tight text-gray-700'
      )}
      {...props}
    >
      {children}
...
export function Header() {
  return (
    <header className="">
      <nav>
        <div className="max-w-10xl mx-none relative  z-50 mx-auto justify-between bg-black  px-[1.8rem]  px-8 max-[1000px]:flex  sm:px-6 sm:px-6  min-[1600px]:px-[4%] ">
          <div className="a9Lpus relative z-10 flex items-center gap-16">
            <Link href="/" aria-label="Home" className="">
              <Logo />
            </Link>
            <div className="hidden items-center justify-center lg:flex lg:gap-10 min-[1200px]:mx-[10%]  min-[1500px]:mx-[25%] min-[1600px]:mx-[20%] min-[1800px]:mx-[34%] min-[1900px]:mx-[39%] ">
              <NavLinks />
            </div>
          </div>
          <div className="flex items-center gap-6">
            <Popover className="lg:hidden">
              {({ open }) => (
                <>
                  <Popover.Button
                    className="relative z-10 -mt-6 inline-flex items-center  stroke-gray-100 p-2 hover:bg-gray-800/50 hover:stroke-gray-100 active:stroke-gray-100 [&:not(:focus-visible)]:focus:outline-none"
                  ...
                  >
                    {({ open }) =>
                      open ? (
                        ...
                        <MobileIcon className=" mr-4 h-10 w-10" />
                      )
                    }
                  </Popover.Button>
                      ...
                      <>
                        ...
                        >
                          <div className="space-y-4 px-2">
                            ...
                            <MobileNavLink href="/albums">Albums</MobileNavLink>
                            <MobileNavLink href="/jokes">Jokes</MobileNavLink>
          ...
          <div class="lg:border-slate-900/15  border-black lg:ml-8 lg:items-center lg:border-l lg:pl-8">
            <Popover className="">
              {({ open }) => (
                <>
                  <Popover.Button
                    className="stroke-theme relative z-10 -m-2 mr-2  inline-flex items-center  bg-sky-50 p-2 hover:stroke-gray-100 active:stroke-gray-100 lg:mr-0 [&:not(:focus-visible)]:focus:outline-none"
                    aria-label="Toggle site navigation"
                  >
                    {({ open }) =>
                      open ? (
