...
const projects = [
  ...
  // { url: NitishCool.src, bg: '#ffff' },
  // { url: NitishCool.src, bg: '#f5c9c8' },

  // { url: NitishCool.src, bg: '#32b5f0' },
  // { url: NitishCool.src, bg: '#c5dfdfc7' },

  // { url: NitishCool.src, bg: '#180909c2' },
  // { url: NitishCool.src, bg: '#18ebed' },
  // { url: NitishCool.src, bg: '#32b5f0' },
