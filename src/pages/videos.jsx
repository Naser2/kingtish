...
import { BoltIcon, ShowsDaysIcon, UsersIcon } from '@heroicons/react/24/outline'
import NitishHeroImg2 from '@/images/nitishIcon.jpeg'
import FadeInSection from '@/components/FadeInSection'
import { SocialLinks } from '@/components/socialLinks'
// import NitishsLogo from '@/public/nitishVideosBanner.jpeg'
// import NitishsMainImg from '@/images/NitishMainImg.png'

import nittyVideosBannerXL from '@/images/nittyVideosBanner2.jpeg'
  ...
  return (
    <>
      <div id="services" className="relative isolate mt-0">
        <img
          src={'/nitishVideosBanner.jpeg'}
          alt="App screenshot"
          width={1832}
          height={1242}
          className="-mt-8 object-cover object-center max-[600px]:aspect-[1070/1388] md:-mt-0 md:mt-0 xl:hidden  xl:rounded-xl min-[1500px]:aspect-[1860/1840]"
        />

        <img
          src={nittyVideosBannerXL.src}
          alt="App screenshot"
          width={1832}
          height={1242}
          className="about-banner -mt-8 object-cover object-center max-[1723px]:hidden max-[600px]:aspect-[1070/1388] md:-mt-0 md:mt-0  xl:rounded-xl min-[1500px]:aspect-[2148/1840]"
        />
        ...
        <div className="max-w-9xl mx-auto items-center  justify-center bg-gray-50/50 px-6 px-6  pt-10 pb-24 pt-2 sm:pb-40 md:px-14 lg:flex">
          ...
          <div className="flex-shrink-1 lg:max-w-10xl mx-auto mt-4 max-w-7xl lg:mx-0 lg:pt-8 ">
